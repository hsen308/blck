/**
 * BLCK Specialty Coffee — Loader, nav, section highlighting, reveal animations
 */
document.addEventListener('DOMContentLoaded', () => {
  ...
  menuGroups.forEach((group) => revealObserver.observe(group));
